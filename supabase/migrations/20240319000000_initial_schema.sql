...
alter table if exists "public"."solar_analyses" enable row level security;
...
create index if not exists solar_analyses_search_id_idx on public.solar_analyses(search_id);
